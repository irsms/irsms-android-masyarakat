...
class RiwayatKecelakaan extends StatefulWidget {
  const RiwayatKecelakaan({super.key});

  @override
  State<RiwayatKecelakaan> createState() => _RiwayatKecelakaanState();
}

class _RiwayatKecelakaanState extends State<RiwayatKecelakaan> {
  String _token = '';
  ...
  void initState() {
    Future.delayed(Duration.zero, () async {
      ...
      if (riwayatKecelakaan['status']) {
        if (riwayatKecelakaan['messages'].length != 0) {
          await Future.delayed(const Duration(seconds: 3));
          if (!mounted) return;
          String msg = riwayatKecelakaan['messages'][0].toString();
